...
export default function BlogDetailPage() {
  ...
  <div className="max-w-3xl mx-auto px-4">
    {/* Breadcrumb */}
    <nav className="text-xs sm:text-sm text-gold-700 mb-4 sm:mb-6" data-aos="fade-right">
    ...
    {/* Views */}
    <p className="text-gold-600 text-xs sm:text-sm mb-2" data-aos="fade-up">
    ...
    {/* Content */}
    <article
      className="prose prose-sm sm:prose-lg max-w-none text-brown-800 prose-headings:text-brown-800 prose-p:leading-relaxed prose-img:rounded-lg"
      data-aos="fade-up"
    >
