              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-brown-600">02-123-4567</p>
                    <p className="text-brown-600">081-234-5678</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-brown-600">info@bencharm.com</p>
                    <p className="text-brown-600">sales@bencharm.com</p>
                  </div>
                </div>
